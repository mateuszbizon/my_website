...
import { LANGUAGE_SCHOOL_IMAGE } from '@/constants/images'
...
function LanguageSchoolPage() {
  return (
    <>
        ...
        <OfferAbout title={LANGUAGE_SCHOOL_OFFER.title} description={LANGUAGE_SCHOOL_OFFER.description} features={LANGUAGE_SCHOOL_OFFER.list} image={LANGUAGE_SCHOOL_IMAGE} />
