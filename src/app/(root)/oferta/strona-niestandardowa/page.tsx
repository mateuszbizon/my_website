...
import { WEB_SITE_IMAGE } from '@/constants/images'
...
function CustomWebSitePage() {
  return (
    <>
        ...
        <OfferAbout title={CUSTOM_WEB_SITE_OFFER.title} description={CUSTOM_WEB_SITE_OFFER.description} features={CUSTOM_WEB_SITE_OFFER.list} image={WEB_SITE_IMAGE} />
