            ...
            <Container>
                <div className='space-y-10'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p>
                            Dane są przetwarzane zgodnie z rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27.04.2016 r. w sprawie ochrony osób fizycznych w związku z przetwarzaniem danych osobowych i w sprawie swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE.
                        </p>
                    </div>
                    <div className='space-y-3'>
